...
namespace comp6771 {
    ...
    public:
        ...
        // PLEASE NOTE I DID NOT WANT TO DO This, but i had no choice, this was the only way i could of implemented
        // caching while keeping the requirement of not modifying the interface in anyway, i had to access the
        // cached value and modify it, the only options were to introduce public methods/make the cache public or make
        // euclidean norm a friend. this was the least harmful way to compute euclidean norm and keep all the spec
    ...
    // i did this PURELY TO KEEP THE REUQIREMENT OF NOT MODIFYING PUBLIC INTERFACE OF EUCLIDEAN VECTOR
    // THIS WAS THE ONLY WAY TO MODIFY THE CACHE STORED PRIVATELY WITHOUT MODIFYING THE INTERFACE!!!!!!!
