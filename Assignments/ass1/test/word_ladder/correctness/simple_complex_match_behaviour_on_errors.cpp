...
auto const ladders_efficient = ::word_ladder::generate("bam", "cam", english_lexicon);
// NOT MADE CONST ON PURPOSE TO TEST THE TEST METHOD ITSELF
auto const ladders_correct = ::word_ladder_slow::generate_accurate("bam", "cam", english_lexicon);
